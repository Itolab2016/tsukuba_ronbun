...
//cout<<"me="<<pointme<<endl;

//cout<<"point3DW="<<point3DW<<endl;
		
		cout<<"t_f="<<t_f<<endl<<endl;
		cout<<"R_f="<<R_f<<endl<<endl;
		//cout<<"point="<<point3D<<endl<<endl;
		cout<<"---------------------------------------------------------------------------"<<endl;
//
...
sprintf(str,"/home/tomas/sasai/data/tokuchou/surfA%04d.png",count);
cv::imwrite(str, img_keypoints11);
sprintf(str,"/home/tomas/sasai/data/tokuchou/surfB%04d.png",count);
cv::imwrite(str, img_keypoints22);
...
//pcl関係
			...
			//	xp.points[xpcount].r=255;
				xpcount++;
				//cout<<xp.points[i].x<<" "<<xp.points[i].y<<" "<<xp.points[i].z<<endl<<endl;
				//xpp.push_back(pcl::PointXYZ(xp.points[i].x,xp.points[i].y,xp.points[i].z));
  			}
